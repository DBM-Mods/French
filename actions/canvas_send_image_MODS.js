module.exports = {
  ...
  Mettre à jour</div>
    <div class="dbmmodsbr2 xinelaslink" data-url="https://github.com/TheKingOfCampers/French">Github: Version 0.3</div>
...
<div>
  <div style="float: left; width: 35%;">
  <span class="dbminputlabel">Envoyez vers</span><br>
...
<span class="dbminputlabel">Message</span><br>
  <textarea id="message" rows="1" placeholder="Entrez votre message ici..." style="width: 100%"></textarea>
</div><br>
<div>
  <div style="float: left; width: 50%;">
  <span class="dbminputlabel">Indiquer comme spoiler</span><br>
...
<div>
<br>
  <div id="embed1"><table><tr><td><div style="float: left; width: 85%;"><span class="dbminputlabel">Embed objet</span><br>
    <select id="storage4" class="round">
      ${data.variables[1]}
    </select>
  </td><td><span class="dbminputlabel">Nom de la variable</span><br>
    <input id="varName4" placeholder="Facultatif" class="round" type="text" list="variableList">
  </td></tr></table>
  </div><br>
  <div style="float: left; width: 35%;">
